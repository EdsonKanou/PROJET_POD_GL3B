        ...
        return(
            <View style={styles.container}>
                <View style={styles.partie1}>
                    <Text style={{fontFamily:"sans-serif-condensed", fontSize:26,textAlign:"center",color:Colors.purple2,fontWeight:"700"}}>
                        BIENVENUE CHEZ Asid_P_IAI by group 4 gl3b
                    </Text>
                ...
                <View style={styles.partie3}>
                    <Pressable style={[ styles.press, styles.press1 ]}
                        ...
                        <Text style={ styles.press1Text}> Confirmer sa presence </Text>
                    </Pressable>
                    <Pressable 
                    ...
                    >
                        <Text style={ styles.press2Text }> Créer un Compte employer</Text>
                    </Pressable>
